...
void InitializeGame()
{
	...
	Load_Music("rubby.ogg");
	Play_Music(1);
	
	Load_Image(1,"fond.bmp",0);
	Load_Image(2,"bird.bmp",1);
	Load_Image(4,"logo.bmp",1);
	Load_Image(5,"score.bmp",1);
	Load_Image(6,"go.bmp",1);
	Load_Image(7,"ddot.bmp",1);
	Load_Image(8,"bird.bmp",1);
	Load_Image(9,"limit_score.bmp",1);
	Load_Image(10,"inst.bmp",1);
	Load_Image(11,"tap.bmp",1);
	Load_Image(12,"tweet.bmp",1);
	Load_Image(13,"copyright.bmp",1);
	
	Load_SFX(1, "dies.wav");
	Load_SFX(2, "tick.wav");
	Load_SFX(3, "alarm.wav");
